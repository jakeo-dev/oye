...
function FeatureCard({
  ...
  return (
    <article className="rounded-2xl border border-stone-700/80 bg-stone-900/40 p-6 shadow-lg shadow-black/20 ring-1 ring-white/5 transition hover:border-orange-400/25 hover:bg-stone-900/60">
      <div
        className="flex h-12 w-12 items-center justify-center rounded-xl bg-orange-400/15 text-orange-400"
        aria-hidden
      >
      ...
      <p className="mt-2 text-pretty text-sm leading-relaxed text-stone-400 md:text-base">
        {description}
      </p>
    </article>
  );
    ...
    >
      ...
      <header className="relative isolate z-10 border-b border-stone-700/80 bg-stone-950/90 text-stone-100 backdrop-blur-md">
        ...
        <div className="relative mx-auto flex max-w-220 items-center justify-between gap-4 px-8 py-4">
          ...
          <Link
            href="/home"
            className="shrink-0 rounded-full bg-orange-400 px-5 py-2.5 text-base font-black text-stone-950 shadow-lg shadow-orange-500/20 outline-none transition hover:bg-orange-300 focus-visible:ring-2 focus-visible:ring-orange-400/80 focus-visible:ring-offset-2 focus-visible:ring-offset-stone-950 md:text-lg"
          >
            Open App
          </Link>
        </div>
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-220 flex-col gap-16 px-8 py-12 md:gap-20 md:py-16">
        <section className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <div className="space-y-6 lg:text-right flex flex-col items-center lg:block">
            <p className="text-sm font-semibold tracking-wide text-orange-400/90 uppercase">
              Listen and learn
            </p>
            <h2 className="text-pretty text-4xl leading-[1.1] font-black tracking-tight text-white md:text-5xl lg:text-6xl">
              Learn what you need to know.
            </h2>
            <p className="max-w-xl text-pretty text-lg leading-relaxed text-stone-400">
              ¡Oye! combines lessons with conversational AI so you can practice
              the way Spanish is actually spoken. Build vocabulary, improve
              pronunciation, and gain confidence for everyday situations.
            </p>
            <div className="flex flex-wrap justify-center lg:justify-end gap-3">
              <Link
                href="/home"
                className="inline-flex items-center gap-2 rounded-full bg-orange-400 px-7 py-3 text-lg font-black text-stone-950 shadow-lg shadow-orange-500/20 outline-none transition hover:bg-orange-300 focus-visible:ring-2 focus-visible:ring-orange-400/80 focus-visible:ring-offset-2 focus-visible:ring-offset-stone-950"
              >
                Start Learning
          ...
          <div className="relative mx-auto w-full max-w-md lg:mx-0">
            <div
              ...
              aria-hidden
            />
            <div className="relative rounded-4xl border border-stone-700/60 bg-linear-to-b from-stone-900/80 to-stone-950/90 p-8 shadow-2xl shadow-black/50 ring-1 ring-white/5 backdrop-blur-sm sm:p-10">
        ...
        <section className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-5">
          ...
          <FeatureCard
            ...
            description="Stay motivated with visible progress so each short practice session compounds over time."
            icon={faChartLine}
          />
        </section>

        <section className="relative overflow-hidden rounded-2xl border border-stone-700/80 bg-stone-900/40 p-8 shadow-lg shadow-black/20 ring-1 ring-white/5 md:p-10">
          <div
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <div className="rounded-xl border border-stone-700/60 bg-stone-950/50 p-5">
              ...
              <p className="mt-2 text-pretty text-sm leading-relaxed text-stone-400">
        ...
        <section className="rounded-2xl border border-orange-400/25 bg-orange-400/10 p-8 text-center shadow-lg shadow-orange-950/10 ring-1 ring-orange-400/15 md:p-10">
          ...
          <Link
            href="/home"
            className="mt-8 inline-flex items-center gap-2 rounded-full bg-orange-400 px-8 py-4 text-xl font-black text-stone-950 shadow-lg shadow-orange-500/25 outline-none transition hover:bg-orange-300 focus-visible:ring-2 focus-visible:ring-orange-400/80 focus-visible:ring-offset-2 focus-visible:ring-offset-stone-950"
          >
            Enter ¡Oye!
